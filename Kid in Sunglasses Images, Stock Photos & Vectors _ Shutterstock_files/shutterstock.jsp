...
if (typeof usi_analytics === 'undefined') {
	usi_analytics = {
		...
		usi_app.load = function () {
			...
			} else if (!usi_app.is_existing_customer && (usi_app.is_footage_in_cart )
					&& usi_date.is_date_within_range(usi_app.now, '2021-2-22 0:01', '2021-3-10 23:59')) {
				usi_split_test.instantiate('34285', usi_app.force_group);
				if (usi_split_test.get_group('34285') == '1') {
					// 25% off sitewide (updated 2/2021)
					usi_commons.log('[ load ] * * * Load 25% Off Sitewide TT * * *');
					usi_commons.load_view("a6YrXQD7hVPDDaGxig5d3ac", "34283", usi_commons.device);
				} else {
					usi_commons.log("[ load ] Split Group: Control");
				}
			} else if (!usi_app.is_existing_customer && !usi_date.is_date_within_range(usi_app.now, '2021-2-22 0:01', '2021-3-10 23:59')) {
				usi_split_test.instantiate('32949', usi_app.force_group);
				if (usi_split_test.get_group('32949') == '1') {
